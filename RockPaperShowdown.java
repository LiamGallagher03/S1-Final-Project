...
//encapsulation
 ...
 public RockPaperShowdown() {
    ...
    if (answerInt == 1) {
        ...
        System.out.println("Respond to a prompt by typing the number correlated to the choice/attack. (type 1 if you want to pick 1. Rock).");
        rps.difficulty();
    }
    else rps.difficulty();
       }
